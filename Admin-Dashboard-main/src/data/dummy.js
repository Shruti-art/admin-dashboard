...
export const EditorData = () => (
  <div>
    ...
    It is the start of a new day and a chance to start fresh. 
    A morning routine can set the tone for the entire day, which is why it 
    is important to start the day right. In this essay, we will discuss the 
    benefits of waking up early, morning routine ideas, the science behind 
    morning, morning rituals around the world, and how to incorporate healthy 
    morning habits into your daily routine.
    </h3>
  </div>
);
